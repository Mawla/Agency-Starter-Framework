...
import {getBlockContentFeatures, htmlToBlocks, normalizeBlock} from '@sanity/block-tools'
import {PortableTextInput} from 'sanity'
import React, {ComponentType, useRef} from 'react'

import {nanoid} from 'nanoid'

export const CustomRichTextEditor: ComponentType<any> = React.forwardRef((props, ref) => {
