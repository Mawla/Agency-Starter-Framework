...
export const BACKGROUND_COLOR_OPTIONS = pick(COLORS, 'white', 'neutral-95');
export type BackgroundColorType = keyof typeof BACKGROUND_COLOR_OPTIONS;

export const IMAGE_COLOR_OPTIONS = pick(
  COLORS,
  'white',
  'green-base',
  'brand-base',
...
export type ImageColorType = keyof typeof IMAGE_COLOR_OPTIONS;
