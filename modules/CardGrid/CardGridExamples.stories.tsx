...
const DEMO_CONTENT = {
  ...
  intro: (
    <p>
      ...
      accumsan, risus sem sollicitudin lacus. Lorem ipsum dolor sit amet, consectetur
      adipiscing elit.
    </p>
  ),
  ...
  <CardGrid
    ...
    items={
      [
        {
          type: 'card.composable',
          title: 'Continuous technical and legal training for all team members.',
          icon: 'demo',
          theme: {
...
export const DemoProcessCardGrid = () => (
  <CardGrid
    ...
    intro={
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit etiam eu turpis
        molestie, dictum est a, mattis tellus. Etiam eu turpis molestie, dictum est
        a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem
        sollicitudin lacus, ut interdum tellus elit sed risus ipsum dolor.{' '}
      </p>
    }
    theme={{
      module: {
  ...
  <CardGrid
    ...
    items={
      new Array(6).fill({
        ...
        text: (
          <p>
            Lorem ipsum dolor sit amet, con sectetur adipiscing elit. Etiam eu turpis
            molestie, dictum est a, mattis tellus.
          </p>
        ),
        image: demoImage3,
      ...
      new Array(6).fill({
        ...
        text: (
          <p>
            ...
            purus luctus enim egestas, ac scelerisque ante pulvinar. Donec ut rhoncus
            ex.
          </p>
        ),
        image: demoImage,
    ...
    items={[
      {
        ...
        text: (
          <p>
            Prima Assicurazioni S.p.A. Piazzale Loreto 17, 20131 Milano (MI) Italy
          </p>
        ),
      },
      {
...
export const DemoPrimaLifegrid = () => (
  <CardGrid
    title="Life at Prima"
    eyebrow="#primalife"
    intro={<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit etiam eu</p>}
    theme={{
      slider: {
        mobile: true,
        desktop: false,
