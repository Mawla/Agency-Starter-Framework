...
import { TITLE_SIZE_OPTIONS } from "./video.options";
import { EllipsisVerticalIcon } from "@sanity/icons";
import { VideoMonitor } from "@vectopus/atlas-icons-react";
...
const schema = defineType({
  ...
  title: "Video",
  type: "object",
  icon: () => <VideoMonitor weight="thin" />,
  description: "Large standalone video",
  preview: {
    select: {
      title: "title",
      image: "image",
    },
    prepare({ title = "Video" }: any) {
      return {
        title: title,
        media: <VideoMonitor weight="thin" />,
      };
    },
  },
  groups: [
